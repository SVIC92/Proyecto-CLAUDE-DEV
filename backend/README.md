...
entrada, y un endpoint con lógica propia de filtrado, ordenamiento y estadísticas), más
un frontend en React/Vite que la consume. La especificación completa del proyecto está
en [`../docs/spec.md`](../docs/spec.md) (la interfaz gráfica queda fuera de esa spec
original; el frontend es una capa adicional para interactuar visualmente con la API).

Este README documenta el backend. Para el frontend, ver [`../frontend/README.md`](../frontend/README.md).
...
Este `backend/` es un paquete pnpm independiente, hermano de `../frontend/` (ver
[`../frontend/README.md`](../frontend/README.md)) y de [`../docs/spec.md`](../docs/spec.md).
